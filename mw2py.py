...
#        var_stack.append( flatten_to_string(toks) )
        ...
        # FIXME: when we are in a nested [], we can not have indices any more
        # so omega[rho[1]] can never refer to index 1!
        # possible solution: count how deep we are in the nested brackets,
        # and only consider checking for older var declerations when we are
        # at the top level
    ...
    def BNF(self):
        ...
        # FIXME: omega[rho[1]], rho[1] is not a vector index!
